...
if ( inspiry_is_search_fields_configured() ) :
    ...
    <div class="as-form-wrap">
        <form class="advance-search-form rh_classic_advance_search_form clearfix" action="<?php echo esc_url( inspiry_get_search_page_url() ); ?>" method="get">
			<?php
			?>
			...
			if ( 'yes' == $collapse_more_fields ) {
                ...
                <div class="more-fields-trigger">
                    <a href="#"><i class="far fa-plus-square"></i> <span><?php esc_html_e( 'More fields', 'framework' ); ?>
                                        </span></a>
                </div>
				<?php
			}
